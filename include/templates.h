...
public:
   ...
   static string grab_function_body(bool plain_method);
   static string generate_function_header(string name, Signature* sig, bool plain_method);
   static string generate_function_header(Function* pf, bool plain_method, bool qualified_names);
};
