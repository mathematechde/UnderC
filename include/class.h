...
public:
  ...
  PEntry find_entry(const string& name);
  int entry_count() const { return (int)m_entries.size(); }
  Table* context();
...
public:
  ...
  bool is_union() const { return m_is_union; }
  ...
  void add_defered_method_body(Function* fn, string body);
