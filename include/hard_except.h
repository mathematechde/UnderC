...
public:
    ...
    Exception(const char *msg, int type = UNKNOWN) : m_what(msg), m_type(type) {}
...
public:
    BadPointer(const char *msg) : Exception(msg,BAD_PTR) { }
};

class HardwareException: public Exception {
public:
    HardwareException(const char *msg,int type) : Exception(msg,type) { }
};

class RangeError: public Exception {
public:
    RangeError(const char *msg) : Exception(msg,RANGE_ERROR) { }
};
