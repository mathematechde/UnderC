...
public:
  ...
  VMByteSize byte_size() const { return m_byte_size; }
  void byte_size(VMByteSize sz) { m_byte_size = sz; }
  ...
  unsigned int size()       const { return m_arg_types.size(); }
